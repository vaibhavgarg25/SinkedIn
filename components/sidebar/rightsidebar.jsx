...
export function RightSidebar() {
  return (
    <div className="hidden w-80 absolute right-0 top-16 h-full bg-background dark:bg-background border-l border-border dark:border-border p-4 overflow-y-auto transition-colors md:block">
      <div className="mb-6">
